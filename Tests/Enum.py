...
class TestIsMemberOf(unittest.TestCase):
    ...
    def test_not_an_enum_raises_assertion(self) -> None:
        ...
        with self.assertRaises(AssertionError): IsMemberOf(int, "x") # type: ignore
    ...
    def test_ensure_member_not_exists_raises(self) -> None:
        ...
        with self.assertRaises(ValueError): EnsureMemberOf(Color, "Yellow")
...
class TestIsValueOf(unittest.TestCase):
    ...
    def test_not_an_enum_raises_assertion(self) -> None:
        ...
        with self.assertRaises(AssertionError): IsValueOf(str, 1) # type: ignore
    ...
    def test_ensure_value_not_exists_raises(self) -> None:
        ...
        with self.assertRaises(ValueError): EnsureValueOf(Color, 99)
...
class TestIsIn(unittest.TestCase):
    ...
    def test_not_an_enum_raises_assertion(self) -> None:
        ...
        with self.assertRaises(AssertionError): IsIn(list, ("x", 1)) # type: ignore
...
class TestTryGet(unittest.TestCase):
    ...
    def test_try_get_member_not_an_enum_raises(self) -> None:
        ...
        with self.assertRaises(AssertionError): TryGetMember(int, lambda _: True, lambda o: o) # type: ignore
...
class TestFlag(unittest.TestCase):
    ...
    def test_ensure_has_flag_raises(self) -> None:
        ...
        with self.assertRaises(ValueError): EnsureHasFlag(Permission.Read, Permission.Write)
