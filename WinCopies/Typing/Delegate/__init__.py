...
type ItemComparison[TItem, TResult] = Callable[[TItem, TItem], TResult]
type EqualityComparison[T] = ItemComparison[T, bool]
type Comparison[T] = ItemComparison[T, bool|None]
