...
class _ReadOnlyListUpdaterBase[TIn, TOut](ValueFunctionUpdater[TOut], IGenericConstraint[TIn, TOut]):
    ...
    @final
    def _GetValue(self) -> TOut: return self._AsContainer(self.__items)
...
class _ReadOnlyLinkedListUpdaterList[T](_ReadOnlyListBase[T, ISinglyLinkedList[T]], IGenericConstraintImplementation[ISinglyLinkedList[T]]):
    def __init__(self, items: ISinglyLinkedList[T]) -> None: super().__init__(items)
@final
class _ReadOnlyLinkedListUpdater[T](_ReadOnlyListUpdaterBase[ISinglyLinkedList[T], IReadOnlyList[T]]):
    def __init__(self, items: ISinglyLinkedList[T], updater: Method[IFunction[IReadOnlyList[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: ISinglyLinkedList[T]) -> IReadOnlyList[T]: return _ReadOnlyLinkedListUpdaterList[T](container)
...
class _ReadOnlyCountableLinkedListUpdaterList[T](_ReadOnlyListBase[T, ICountableSinglyLinkedList[T]], CountableBase, IReadOnlyCountableList[T], IGenericConstraintImplementation[ICountableSinglyLinkedList[T]]):
    def __init__(self, items: ICountableSinglyLinkedList[T]) -> None: super().__init__(items)
...
class _ReadOnlyCountableLinkedListUpdater[T](_ReadOnlyListUpdaterBase[ICountableSinglyLinkedList[T], IReadOnlyCountableList[T]]):
    def __init__(self, items: ICountableSinglyLinkedList[T], updater: Method[IFunction[IReadOnlyCountableList[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: ICountableSinglyLinkedList[T]) -> IReadOnlyCountableList[T]: return _ReadOnlyCountableLinkedListUpdaterList[T](container)
...
class _ReadOnlyEnumerableLinkedListUpdater[T](_ReadOnlyListUpdaterBase[IEnumerableList[T], IReadOnlyEnumerableList[T]]):
    def __init__(self, items: IEnumerableList[T], updater: Method[IFunction[IReadOnlyEnumerableList[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: IEnumerableList[T]) -> IReadOnlyEnumerableList[T]: return _ReadOnlyEnumerableLinkedListUpdaterList[T](container)
...
class _ReadOnlyCountableEnumerableLinkedListUpdater[T](_ReadOnlyListUpdaterBase[ICountableEnumerableList[T], IReadOnlyCountableEnumerableList[T]]):
    def __init__(self, items: ICountableEnumerableList[T], updater: Method[IFunction[IReadOnlyCountableEnumerableList[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: ICountableEnumerableList[T]) -> IReadOnlyCountableEnumerableList[T]: return _ReadOnlyCountableEnumerableLinkedListUpdaterList[T](container)
...
class _ReadOnlyCountableEnumerableList[T](ICountableEnumerableList[T]):
    ...
    @final
    def AsReadOnly(self) -> IReadOnlyCountableEnumerableList[T]: return self.__updater.GetValue()
...
class LinkedListBase[TItem, TList](Abstract, ISinglyLinkedList[TItem], GenericConstraint[TList, IReadWriteList[TItem]]):
    ...
    @final
    def TryPeek(self) -> INullable[TItem]: return self._GetInnerContainer().TryGetFirst()
    
    @final
    def TryPop(self) -> INullable[TItem]: return self._GetInnerContainer().TryRemoveFirst()
...
class QueueBase[TItems, TList](LinkedListBase[TItems, TList], IQueue[TItems]):
    ...
    @final
    def Push(self, value: TItems) -> None: self._GetInnerContainer().AddLastNode(value)
    @final
    def PushItems(self, items: Iterable[TItems]) -> None: self._GetInnerContainer().AddLastItems(items)
class StackBase[TItems, TList](LinkedListBase[TItems, TList], IStack[TItems]):
    def __init__(self, l: TList) -> None: super().__init__(l)
    
    @final
    def Push(self, value: TItems) -> None: self._GetInnerContainer().AddFirstNode(value)
    @final
    def PushItems(self, items: Iterable[TItems]) -> None: self._GetInnerContainer().AddFirstItems(items)
...
class AbstractReadOnlyList[T](IReadOnlyList[T]):
    ...
    @final
    def GetOrder(self) -> EnumerationOrder: return EnumerationOrder.Both

class AbstractList[TItem, TList](LinkedListBase[TItem, TList], AbstractReadOnlyList[TItem]):
    def __init__(self, l: TList) -> None: super().__init__(l)
    
    @final
    def Push(self, value: TItem) -> None: self._GetInnerContainer().AddLastNode(value)
    @final
    def PushItems(self, items: Iterable[TItem]) -> None: self._GetInnerContainer().AddLastItems(items)
...
class LinkedList[T](AbstractList[T, IReadWriteList[T]], _ReadOnlyList[T], IGenericConstraintImplementation[IReadWriteList[T]]):
    def __init__(self, l: IReadWriteList[T]|None = None) -> None:
        def update(func: IFunction[IReadOnlyList[T]]) -> None: self.__updater = func
...
class _QueueUpdater[T](_ReadOnlyListUpdaterBase[IQueue[T], IReadOnlyQueue[T]]):
    def __init__(self, items: IQueue[T], updater: Method[IFunction[IReadOnlyQueue[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: IQueue[T]) -> IReadOnlyQueue[T]: return _ReadOnlyQueueUpdaterList[T](container)
...
class _StackUpdater[T](_ReadOnlyListUpdaterBase[IStack[T], IReadOnlyStack[T]]):
    def __init__(self, items: IStack[T], updater: Method[IFunction[IReadOnlyStack[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: IStack[T]) -> IReadOnlyStack[T]: return _ReadOnlyStackUpdaterList[T](container)
...
class AbstractReadOnlyEnumerableList[TItem, TList](ReadOnlyListBase[TItem, TList], IReadOnlyEnumerableList[TItem], GenericSpecializedConstraint[TList, ISinglyLinkedList[TItem], IReadOnlyEnumerableList[TItem]]):
    ...
    @final
    def TryGetEnumerator(self) -> IEnumerator[TItem]|None: return TryCreateEnumerator(self._GetSpecializedContainer().TryGetEnumerator())
...
class _CountableUpdater(ValueFunctionUpdater[ICountable]):
    ...
    def _GetValue(self) -> ICountable: return CreateCountable(self.__collection)
@final
class _EnumerableUpdater[T](SelectionUpdater[IReadOnlyEnumerableList[T], Iterable[T]]):
    def __init__(self, items: IReadOnlyEnumerableList[T], updater: Method[IFunction[Iterable[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: IReadOnlyEnumerableList[T]) -> Iterable[T]: return CreateEnumerable(container)
@final
class _CountableEnumerableUpdater[T](ValueFunctionUpdater[CountableEnumerableBase[T]]):
    ...
    def _GetValue(self) -> CountableEnumerableBase[T]: return CreateCountableEnumerable(self.__collection)
...
class _ReadOnlyCountableQueueUpdaterList[T](AbstractReadOnlyCountableList[T, ICountableQueue[T]], IReadOnlyCountableQueue[T], IGenericSpecializedConstraintImplementation[ISinglyLinkedList[T], ICountableQueue[T]]):
    def __init__(self, items: ICountableQueue[T]) -> None:
        def update(func: IFunction[ICountable]) -> None: self.__updater = func
        
        super().__init__(items)

        self.__updater: IFunction[ICountable] = _CountableUpdater(self, update) # type: ignore[no-redef]
    
    def AsSized(self) -> Sized: return self.__updater.GetValue().AsSized()
@final
class _CountableQueueUpdater[T](_ReadOnlyListUpdaterBase[ICountableQueue[T], IReadOnlyCountableQueue[T]]):
    ...
    def _AsContainer(self, container: ICountableQueue[T]) -> IReadOnlyCountableQueue[T]: return _ReadOnlyCountableQueueUpdaterList[T](container)
...
class _CountableStackUpdater[T](_ReadOnlyListUpdaterBase[ICountableStack[T], IReadOnlyCountableStack[T]]):
    ...
    def _AsContainer(self, container: ICountableStack[T]) -> IReadOnlyCountableStack[T]: return _ReadOnlyCountableStackUpdaterList[T](container)
...
class _ReadOnlyEnumerableQueueUpdaterList[T](AbstractReadOnlyEnumerableList[T, IEnumerableQueue[T]], IReadOnlyEnumerableQueue[T], IGenericSpecializedConstraintImplementation[ISinglyLinkedList[T], IEnumerableQueue[T]]):
    def __init__(self, items: IEnumerableQueue[T]) -> None:
        def update(func: IFunction[Iterable[T]]) -> None: self.__updater = func
        
        super().__init__(items)

        self.__updater: IFunction[Iterable[T]] = _EnumerableUpdater[T](self, update) # type: ignore[no-redef]
    
    def AsIterable(self) -> Iterable[T]: return self.__updater.GetValue()
@final
class _EnumerableQueueUpdater[T](_ReadOnlyListUpdaterBase[IEnumerableQueue[T], IReadOnlyEnumerableQueue[T]]):
    def __init__(self, items: IEnumerableQueue[T], updater: Method[IFunction[IReadOnlyEnumerableQueue[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: IEnumerableQueue[T]) -> IReadOnlyEnumerableQueue[T]: return _ReadOnlyEnumerableQueueUpdaterList[T](container)
...
class _EnumerableStackUpdater[T](_ReadOnlyListUpdaterBase[IEnumerableStack[T], IReadOnlyEnumerableStack[T]]):
    def __init__(self, items: IEnumerableStack[T], updater: Method[IFunction[IReadOnlyEnumerableStack[T]]]) -> None: super().__init__(items, updater)
    
    def _AsContainer(self, container: IEnumerableStack[T]) -> IReadOnlyEnumerableStack[T]: return _ReadOnlyEnumerableStackUpdaterList[T](container)
...
class _ReadOnlyCountableEnumerableQueueUpdaterList[T](AbstractReadOnlyCountableEnumerableList[T, ICountableEnumerableQueue[T]], IReadOnlyCountableEnumerableQueue[T], IGenericSpecializedConstraintImplementation[ISinglyLinkedList[T], ICountableEnumerableQueue[T]]):
    def __init__(self, items: ICountableEnumerableQueue[T]) -> None:
        def update(func: IFunction[CountableEnumerableBase[T]]) -> None: self.__updater = func
...
class _CountableEnumerableQueueUpdater[T](_ReadOnlyListUpdaterBase[ICountableEnumerableQueue[T], IReadOnlyCountableEnumerableQueue[T]]):
    ...
    def _AsContainer(self, container: ICountableEnumerableQueue[T]) -> IReadOnlyCountableEnumerableQueue[T]: return _ReadOnlyCountableEnumerableQueueUpdaterList[T](container)
...
class _CountableEnumerableStackUpdater[T](_ReadOnlyListUpdaterBase[ICountableEnumerableStack[T], IReadOnlyCountableEnumerableStack[T]]):
    ...
    def _AsContainer(self, container: ICountableEnumerableStack[T]) -> IReadOnlyCountableEnumerableStack[T]: return _ReadOnlyCountableEnumerableStackUpdaterList[T](container)

class Queue[T](QueueBase[T, IReadWriteList[T]], IGenericConstraintImplementation[IReadWriteList[T]]):
    def __init__(self, l: IReadWriteList[T]|None = None) -> None:
        def update(func: IFunction[IReadOnlyQueue[T]]) -> None: self.__updater = func
    ...
    @final
    def AsReadOnly(self) -> IReadOnlyQueue[T]: return self.__updater.GetValue()
class Stack[T](StackBase[T, IReadWriteList[T]], IGenericConstraintImplementation[IReadWriteList[T]]):
    def __init__(self, l: IReadWriteList[T]|None = None) -> None:
        def update(func: IFunction[IReadOnlyStack[T]]) -> None: self.__updater = func
    ...
    @final
    def AsReadOnly(self) -> IReadOnlyStack[T]: return self.__updater.GetValue()
...
class CountableQueue[T](QueueBase[T, ICountableDoublyLinkedList[T]], ICountableQueue[T], IGenericConstraintImplementation[IReadWriteList[T]]):
    def __init__(self, l: ICountableDoublyLinkedList[T]|None = None) -> None:
        def update(func: IFunction[IReadOnlyCountableQueue[T]]) -> None: self.__updater = func
    ...
    @final
    def AsReadOnly(self) -> IReadOnlyCountableQueue[T]: return self.__updater.GetValue()
class CountableStack[T](StackBase[T, ICountableDoublyLinkedList[T]], ICountableStack[T], IGenericConstraintImplementation[IReadWriteList[T]]):
    def __init__(self, l: ICountableDoublyLinkedList[T]|None = None) -> None:
        def update(func: IFunction[IReadOnlyCountableStack[T]]) -> None: self.__updater = func
    ...
    @final
    def AsReadOnly(self) -> IReadOnlyCountableStack[T]: return self.__updater.GetValue()
...
class EnumerableQueue[T](QueueBase[T, IDoublyLinkedList[T]], IEnumerableQueue[T], IGenericConstraintImplementation[IDoublyLinkedList[T]]):
    def __init__(self, l: IDoublyLinkedList[T]|None = None) -> None:
        def updateReadOnly(func: IFunction[IReadOnlyEnumerableQueue[T]]) -> None: self.__readOnly = func
...
class CountableEnumerableQueue[T](QueueBase[T, ICountableDoublyLinkedList[T]], ICountableEnumerableQueue[T], IGenericConstraintImplementation[ICountableDoublyLinkedList[T]]):
    def __init__(self, l: ICountableDoublyLinkedList[T]|None = None) -> None:
        def update(func: IFunction[IReadOnlyCountableEnumerableQueue[T]]) -> None: self.__updater = func
    ...
    @final
    def AsReadOnly(self) -> IReadOnlyCountableEnumerableQueue[T]: return self.__updater.GetValue()
class CountableEnumerableStack[T](StackBase[T, ICountableDoublyLinkedList[T]], ICountableEnumerableStack[T], IGenericConstraintImplementation[ICountableDoublyLinkedList[T]]):
    def __init__(self, l: ICountableDoublyLinkedList[T]|None = None) -> None:
        def update(func: IFunction[IReadOnlyCountableEnumerableStack[T]]) -> None: self.__updater = func
    ...
    @final
    def AsReadOnly(self) -> IReadOnlyCountableEnumerableStack[T]: return self.__updater.GetValue()