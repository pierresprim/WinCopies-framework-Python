...
from WinCopies.Collections.Registry.Keyable import IKeyableObjectRegistry
from WinCopies.Collections.Registry.Mapping import KeyedDisposableObjectRegistry
